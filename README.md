...
Arcanum has undergone multiple independent security audits. Reports are published in [`/audits`](audits/).

| Date | Type |
|---|---|
| 2026-06-16 | Full codebase audit |
| 2026-06-19 | Follow-up audit (prior findings verification) |
| 2026-06-20 | Pre-release audit — final checkpoint |
